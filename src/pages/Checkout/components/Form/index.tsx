  ...
  return (
    <FormContainer {...rest} onSubmit={handleSubmit(handleFormSubmit)}>
      ...
      <Row marginTop="1rem" gap={12} wrapRow={true} data-row>
        ...
        <Col flex="8" data-col>
          <Input wFull placeholder="Cidade" {...register("city")} />
          {errors.city && (
            <ErrorMessage marginTop="0.4rem">
              {errors.city.message}
            </ErrorMessage>
        ...
        <Col flex="2" data-col>
          <Input wFull placeholder="UF" {...register("fu")} />
          {errors.fu && (
            <ErrorMessage marginTop="0.4rem"> {errors.fu.message}</ErrorMessage>
          )}
        </Col>
      </Row>
    </FormContainer>
