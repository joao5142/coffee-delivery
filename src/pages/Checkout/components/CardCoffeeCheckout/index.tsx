      ...
      {coffees.length > 0 ? (
        <div>
          <CardCoffeeCheckoutContainer>
            {coffees.map((coffee) => {
              return (
                <CardCoffeeCheckoutRow key={coffee.id}>
                  <Col>
                    <Row gap={20}>
                        ...
                        <Row marginTop="0.5rem" wrapRow={true} gap={5}>
                          <Col flex="1.5">
                            <InputNumber
                              ...
                              onValueChange={(value) =>
                                handleChangeCoffeeQuantity(value, coffee)
                              }
                              wFull={true}
                            />
                          </Col>
                          <Col flex="2">
                            <RemoveCoffeeButton
                              wFull={true}
                              onClick={() =>
                                handleRemoveCoffeeInCart(coffee.id)
                              }
                            >
                              <TrashIcon />{" "}
                              <Text
          ...
          <Row gap={12} direction="column" marginTop="1.5rem">
            <Row justify="between">
              ...
              />
              <Text
                text={formatCurrency(totalCoffeesPrice)}
                size="m"
                element="span"
                color="gray_700"
              />
            ...
            <Row justify="between">
              ...
              <Text
                text={formatCurrency(deliveryPrice)}
                size="m"
                element="span"
                color="gray_700"
              />
        ...
        <Text element="p" text="Selecione ao menos um café :)" />
      )}
    </>
  );
}
