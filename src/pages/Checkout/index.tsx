...
export function Checkout() {
	...
	const [paymentOption, setPaymentOption] = useState<PAYMENT_OPTION>(paymentModeSelected);
	...
	const setCoffeesToInitialState = useContextSelector(CoffeeContext, (context) => {
	...
	async function handleNavigateFinishedOrder() {
		try {
			...
			Alert.error("Não foi possivel alterar o endereço. Tente novamente mais tarde!");
		}
	}
	return (
		<CheckoutContainer>
				...
				<Row gap={32} marginTop="3.2rem" justify="between" wrapRow={true}>
					<Col flex="2">
						...
						<CardContainer data-form-card>
							...
							<Form id="payment-form" onFormSubmit={(data) => handleNavigateFinishedOrder(data)} />
						</CardContainer>
