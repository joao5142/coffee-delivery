						...
						<CardContainer data-card-selected-coffees>
							...
							<Row gap={12} direction="column" marginTop="1.5rem">
								<Row justify="between">
									...
									<Text text="R$ 29,70" size="m" element="span" color="gray_700" />
								</Row>
								<Row justify="between">
									<Text text="Entrega" size="s" element="span" color="gray_700" />
									<Text text="R$ 3,50" size="m" element="span" color="gray_700" />
								</Row>
								<Row justify="between">
									<Text text="Total" size="l" element="span" color="gray_700" weight="bold" />
									<Text text="R$ 33,20" size="l" element="span" color="gray_700" weight="bold" />
								</Row>
							</Row>
