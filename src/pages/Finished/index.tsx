							...
							<Row padding="2.5rem" direction="column">
								<Row gap={12} marginBottom="2rem">
									...
									<Col>
										<Text element="p">
											Entrega em
											<Text text=" Rua João Daniel Martinelli, 102" element="strong" weight="bold" color="gray_700" />
										</Text>
								...
								<Row gap={12}>
									...
									<Col>
										...
										<Text text="Cartão de Crédito" element="strong" weight="bold" color="gray_700" />
									</Col>
								</Row>
							</Row>
						</CardInfos>
