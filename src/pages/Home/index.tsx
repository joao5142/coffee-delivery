...
export function Home() {
	...
	return (
		<MainContainer>
							...
							<Row gap={40} marginBottom="1.5rem" data-option-items>
								...
								<div>
									...
									<Row gap={10} marginBottom="1.5rem" align="center">
										...
										<Text element="span" text="O café chega fresquinho até você" />
									</Row>
								</div>
							</Row>
						</Col>
						<Col flex="1">
							<Row justify="end" data-container-coffee-image>
								<img src={coffeeDeliveryImage} alt="Copo  de café da coffeedelivery" />
							</Row>
						</Col>
					</Row>
				</Container>
			...
			<section>
				<Container>
					<Text marginBottom="3.375rem" text="Nossos cafés" element="h2" fontFamily="BALOO" size="l" />
					<GridContainer>
						{coffees.map((coffee) => {
