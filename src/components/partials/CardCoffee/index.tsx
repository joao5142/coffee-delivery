...
import { CardCoffeeContainer, CoffeeTag, ImageCoffee, ShoppingCartIcon } from "./styles";
...
export function CardCoffee({ coffee }: CardCoffeeProps) {
	return (
		<CardCoffeeContainer>
			...
			<Text marginBottom="0.5rem" text={coffee.name} element="h4" fontFamily="BALOO" color="gray_800" size="s" />
